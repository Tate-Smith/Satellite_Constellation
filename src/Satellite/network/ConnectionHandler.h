...
class ConnectionHandler {
    ...
    public:
        ConnectionHandler(MessageQueue<std::string> *loggerQueue, int listeningPort); // constructor to instialize the queue
        ...
        bool hasConnection(int peerId);
        void heartbeatSat(int peerId); // sends a heartbeat and sets connection to connected
